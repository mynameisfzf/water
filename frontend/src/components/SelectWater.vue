<template>
  <div class="ctx">
    <div class="top">
      ...
      <router-link class="next" to="/set" v-if="store.state.waterfile.length>0">下一步</router-link>

    </div>

    <div class="images" v-if="store.state.waterfile.length>0">
    ...
    <div v-else class="select" @click="select">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
        ...
        <linearGradient id="xGIh33lbYX9pWIYWeZsukb_zRCxfHhAkOiL_gr2" x1="24.066" x2="24.066" y1="19.228" y2="33.821"
...
import {GetWaterFiles, SelectWaterFiles} from '../../wailsjs/go/main/App.js'
